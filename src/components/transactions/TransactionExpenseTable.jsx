...
export default function TransactionExpenseTable({
  transactions,
  onEdit,
  onDelete,
  isAdmin,
        ...
        >
          ...
          <div className="grid grid-cols-2 mt-3 text-sm gap-x-4 gap-y-2">
            ...
            <div>
              ...
              <span className="px-1.5 py-0.5 bg-red-100 text-red-800 text-xs rounded dark:bg-red-900/30 dark:text-red-400 transition-colors duration-200">
            ...
            <div className="flex items-center justify-between col-span-2 pt-2 mt-2 transition-colors duration-200 border-t border-gray-100 dark:border-gray-700">
              {transactionItem.proofImage ? (
                <button
                  ...
                  className="flex items-center text-blue-500 transition-colors duration-200 dark:text-blue-400"
                >
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex space-x-3">
                    <button
                      ...
                      className="p-1.5 text-blue-500 hover:text-blue-700 transition-colors dark:text-blue-400 dark:hover:text-blue-300  duration-200"
                    ...
                    <button
                      ...
                      className="p-1.5 text-red-500 hover:text-red-700 transition-colors dark:text-red-400 dark:hover:text-red-300  duration-200"
    ...
    <div>
      ...
      {imagePreview.isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
          ...
          <div className="relative z-10 p-3 sm:p-4 bg-white rounded-lg shadow-lg w-full max-w-lg max-h-[90vh] flex flex-col dark:bg-gray-800 transition-colors duration-200">
            <div className="flex items-center justify-between mb-2 sm:mb-3">
              ...
              <button
                onClick={() => setImagePreview({ isOpen: false, url: "" })}
                className="text-gray-500 hover:text-gray-700 p-1.5 dark:text-gray-300 dark:hover:text-gray-100 transition-colors duration-200"
...
TransactionExpenseTable.propTypes = {
