...
export default function TransactionTable({
  ...
  // Render type badge with appropriate colors
        ...
        >
          ...
          <div className="grid grid-cols-2 mt-3 text-sm gap-x-4 gap-y-2">
            ...
            <div>
              ...
              {renderTypeBadge(transactionItem.type)}
            </div>
            ...
            <div className="flex items-center justify-between col-span-2 pt-2 mt-2 transition-colors duration-200 border-t border-gray-100 dark:border-gray-700">
              {transactionItem.proofImage ? (
                <button
                  ...
                  className="flex items-center text-blue-500 transition-colors duration-200 dark:text-blue-400 hover:text-blue-600 dark:hover:text-blue-300"
                >
        ...
        <tbody className="transition-colors duration-200 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
          {transactions?.map((transactionItem) => (
            <tr
              ...
              className="transition-colors duration-200 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700/30"
            >
                ...
                <td className="px-3 py-4 whitespace-nowrap">
                  <div className="flex space-x-3">
                    <button
                      ...
                      className="p-1.5 text-blue-500 hover:text-blue-700 transition-colors dark:text-blue-400 dark:hover:text-blue-300"
                    ...
                    <button
                      ...
                      className="p-1.5 text-red-500 hover:text-red-700 transition-colors dark:text-red-400 dark:hover:text-red-300"
