  ...
  if (!data || !Array.isArray(data) || data.length === 0) {
    return (
      <div className="p-4 text-center text-gray-500 transition-colors duration-200 dark:text-gray-400">
        Data kinerja penjualan tidak tersedia
      </div>
    );
  }
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-2 text-sm">
            ...
            <div>
              ...
              <p className="font-medium text-green-600 transition-colors duration-200 dark:text-green-400">
          ...
          <tbody className="transition-colors duration-200 divide-y divide-gray-200 dark:divide-gray-700">
            {data.map((item, index) => (
              ...
              >
                ...
                <td className="px-4 py-2 font-medium text-green-600 transition-colors duration-200 whitespace-nowrap dark:text-green-400">
                  {formatCurrency(item.totalSales)}
                </td>
              </tr>
            ))}
